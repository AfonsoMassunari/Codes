...
//função para controlar apenas o bit referente a um pino
...
//função para ler apenas o bit referente a um pino
...
//função para configurar apenas um pino como entrada ou saída
